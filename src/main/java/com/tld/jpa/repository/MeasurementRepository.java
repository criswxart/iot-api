...
public interface MeasurementRepository extends JpaRepository<Measurement,Long> {
	String querySql="""			
					select m.measurement_id as id ,
						   ...
						   TO_CHAR( m.measurement_created_at, 'DD-MM-YYYY HH24:MI')::VARCHAR(255) AS record_saved_at, 
						   TO_CHAR( m.measurement_modified_at, 'DD-MM-YYYY HH24:MI')::VARCHAR(255) AS record_modified_at,
